...
export const ritualText = `
    ...
    <br>
    <p>The possibilities are almost endless, but the most important thing is choosing rituals that feel meaningful to you.</p>
    <br>
    <p>When thoughtfully woven into your ceremony, these aren't simply additions to the day, they become some of the most memorable moments, creating lasting memories for both you and your guests.</p>
    <br>
    <p>Some you could consider are:</p>
    <br>
    <p>Handfasting – the origin for tying the knot – where your hands are bound together using ribbons or a handfasting cord.</p>
    <br>
    <p>A Unity Candle – where the two single flames light a single candle – signifying two becoming one.</p>
    <br>
    <p>Ring Warming – the rings, the symbols of your marriage, are passed among your guests to allow them to infuse them with good wishes, blessings and love before they are exchanged.</p>
    <br>
    <p>Sand Ceremony – where individual colours of sand are blended into something beautiful and inseparable. This one works well if you want to involve children in the ceremony.</p>
    <br>
    <p>You may want to honour absent loved ones through a memory table or a special moment of reflection. Or you may choose a tree planting ceremony, a love letter box or wine ceremony to be opened in years to come, or the sharing of a Celtic loving cup as a symbol of unity and togetherness.</p> 
    <br>
    <p>Or it may be something that is unique to you.</p>
    <br>
    <p>Whatever you choose, together, we'll create a ceremony filled with moments that feel authentically yours—and only yours.</p>
    `